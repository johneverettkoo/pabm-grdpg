...
of the $\{z_i\}$; we do, however, occassionally assume that the $n_k$
...
orthogonal subspaces, i.e., and the rows of $X$ consist of
vectors that lie in $\mathcal{S}_1 \cup \mathcal{S}_2$ where
$\mathcal{S}_1$ and $\mathcal{S}_2$ are both $2$-dimensional
subspaces of $\mathbb{R}^{4}$, $\mathcal{S}_1 \cap \mathcal{S}_2 = \{0\}$, and $x^{\top} y
...
points are then the columns with indices $r(K+1) +1 $ for $0 \leq r
