...
\begin{center}\includegraphics[width=0.5\linewidth]{slides_files/figure-beamer/unnamed-chunk-5-1} \end{center}

\vspace*{.5\baselineskip}

\begin{center}\includegraphics[width=0.5\linewidth]{slides_files/figure-beamer/unnamed-chunk-6-1} \end{center}
\end{column}
