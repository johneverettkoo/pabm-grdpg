...
* Estimation via EM
  * May require *ad hoc* approximations
...
* Estimation via ASE
  ...
  * Non-identifiable linear transformation

::::

:::

## All Bernoulli Graph models are (G)RDPGs

* Can we use this for inference on Block Models?
...
* In this example, $p = q = 1/2$, $r = 1/8$, and $\omega_i \in (0, 1)$.
