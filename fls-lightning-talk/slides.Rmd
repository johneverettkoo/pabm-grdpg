...
1. $P$ is an $n \times n$ matrix of edge probabilities between pairs of vertices.
...
```{r, fig.height = 3, fig.width = 4, out.width = '100%', fig.cap = 'Two community SBM with $p=1/2$, $q=1/4$, $r=1/8$'}
n1 <- 2 ** 5
n2 <- 2 ** 5
n <- n1 + n2
...
We compared a variety of algorithms for community detection on randomly generated PABMs:  
